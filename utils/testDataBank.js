...
const TEST_CASE_ID_IDENTIFIER = "id";
const TEST_CASE_NAME_IDENTIFIER = "name";
const TEST_CASE_LEFTNAV_IDENTIFIER = "leftNav";
const TEST_CASE_COLUMN_IDENTIFIER = "column";
const TEST_CASE_TASK_CARD_TITLE_IDENTIFIER = "card_title";
const TEST_CASE_TAGS_IDENTIFIER = "tags";
